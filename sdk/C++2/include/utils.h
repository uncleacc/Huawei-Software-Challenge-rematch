 ...
 */
bool can_place_boat(const std::vector<std::pair<int, int>> &points, int ts);
...
bool check_boat_can_loc_dir(const std::vector<std::pair<int, int>> &points);
...
bool check_boat_loc_slow(const std::vector<std::pair<int, int>> &points);
